...
export default function DashboardPage() {
  ...
  const metrics = [
    { title: 'Listings', value: counts.listings, icon: Building2, href: '/listings' },
    { title: 'Blog Posts', value: counts.blogs, icon: FileText, href: '/blogs' },
    { title: 'Testimonials', value: counts.testimonials, icon: MessageSquareQuote, href: '/testimonials' },
  ];
