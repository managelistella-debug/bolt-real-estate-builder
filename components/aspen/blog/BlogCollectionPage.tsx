  ...
  return (
    <>
      <section className="relative w-full pt-[100px] md:pt-[140px] pb-10 md:pb-[60px] overflow-hidden">
        <div className="absolute inset-0 parallax-bg" style={{ backgroundImage: "url(/images/blog-banner.webp)" }} />
        ...
        <div className="max-w-[1440px] mx-auto px-5 md:px-10 lg:px-[60px] py-10 md:py-[60px]">
          <AnimatePresence mode="wait" custom={direction}>
            ...
            >
              {featuredPost && (
                <ScrollReveal>
                  <Link href={`/blog/${featuredPost.slug}`} className="block group mb-10 md:mb-14">
                    <div className="flex flex-col lg:flex-row gap-6 md:gap-8 lg:gap-10">
                      ...
                      <div className="flex-1 flex flex-col justify-center">
                        {featuredPost.category && (
                          <span className="gold-gradient-text text-[12px] md:text-[13px] uppercase tracking-[0.1em] mb-2 md:mb-3" style={{ fontFamily: "'Lato', sans-serif" }}>
                            {featuredPost.category}
                          </span>
                        )}
                        <h2 className="font-heading text-[24px] sm:text-[28px] md:text-[34px] lg:text-[38px] leading-[1.2] text-white group-hover:text-[#daaf3a] transition-colors duration-300" style={{ fontWeight: 400 }}>
                          {featuredPost.title}
                        </h2>
                        <p className="mt-3 md:mt-4 text-white/50 text-[13px] md:text-[14px]" style={{ fontFamily: "'Lato', sans-serif" }}>
                          {formatDate(featuredPost.publishDate)} &middot; {featuredPost.author}
                        </p>
                        ...
                        <div className="mt-5 md:mt-6">
                          <span className="inline-flex items-center justify-center gold-gradient-bg h-[42px] px-6 text-[#09312a] font-semibold text-[13px] md:text-[14px] transition-all duration-300" style={{ fontFamily: "'Lato', sans-serif" }}>
                            Read Article
                          </span>
                        </div>
                      </div>
                  ...
                  <ScrollReveal key={post.id} delay={index * 0.06}>
                    <Link href={`/blog/${post.slug}`} className="block group">
                      ...
                      <div className="pt-4 md:pt-5 pb-5 md:pb-6 border-b border-white/10">
                        {post.category && (
                          <span className="gold-gradient-text text-[11px] md:text-[12px] uppercase tracking-[0.1em]" style={{ fontFamily: "'Lato', sans-serif" }}>
                            {post.category}
                          </span>
                        )}
                        <h3 className="font-heading text-[20px] md:text-[24px] leading-[1.25] text-white mt-2 group-hover:text-[#daaf3a] transition-colors duration-300" style={{ fontWeight: 400 }}>
                          {post.title}
                        </h3>
                        ...
                        <div className="mt-4">
                          <span className="text-[#daaf3a] text-[13px] md:text-[14px] font-semibold group-hover:underline transition-all duration-300" style={{ fontFamily: "'Lato', sans-serif" }}>
                            Read Now
                          </span>
                        </div>
                      </div>
