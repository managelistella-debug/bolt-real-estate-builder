    ...
    <>
      ...
      <section className="relative w-full pt-[100px] md:pt-[140px] pb-10 md:pb-[60px] overflow-hidden">
        <div
          ...
          style={{ backgroundImage: "url(/images/active-listings-banner.webp)" }}
        />
        ...
        <div className="relative z-10 max-w-[1440px] mx-auto px-5 md:px-10 lg:px-[60px]">
          ...
          >
            Explore our current properties for sale in Sundre, Olds, and across
          ...
          >
            <span
              ...
              style={{ fontFamily: "'Lato', sans-serif" }}
            >
              {allListings.length} {allListings.length === 1 ? "property" : "properties"} available
            </span>
          </motion.div>
        </div>
      </section>
            ...
            >
              {currentListings.map((listing, index) => (
                <ScrollReveal key={listing.id} delay={index * 0.08}>
                  <ListingCard listing={listing} showPrice={true} />
                </ScrollReveal>
              ))}
            </motion.div>
          </AnimatePresence>
