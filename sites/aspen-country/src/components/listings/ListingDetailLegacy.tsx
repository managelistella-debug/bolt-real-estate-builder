                  ...
                  <div className="border-t border-white/10">
                    {detailItems.map((item) => (
                      <div key={item.label} className="flex items-center justify-between py-3 md:py-4 border-b border-white/10">
                        <span className="text-white/50 text-[14px] md:text-[15px]" style={{ fontFamily: "'Lato', sans-serif" }}>
                          {item.label}
                        </span>
                        <span className="text-white text-[14px] md:text-[15px] font-normal text-right" style={{ fontFamily: "'Lato', sans-serif" }}>
                          {item.value}
                        </span>
                      </div>
                    ))}
