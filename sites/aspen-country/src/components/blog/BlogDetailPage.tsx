      ...
      <section className="bg-[#09312a]">
        <div className="max-w-[1440px] mx-auto px-5 md:px-10 lg:px-[60px] py-10 md:py-[60px]">
          ...
          >
            <Link
              href="/blog"
              className="text-white/50 text-[13px] md:text-[14px] hover:text-white transition-colors duration-300"
            >
              Blog
            </Link>
          </motion.nav>
          ...
          <div className="max-w-[800px]">
            ...
            >
              {post.tags.map((tag) => (
                <span
                  key={tag}
                  className="px-3 py-1 border border-white/15 text-white/50 text-[11px] md:text-[12px]"
                  style={{ fontFamily: "'Lato', sans-serif" }}
                >
                  {tag}
                </span>
            ...
            <motion.div
              ...
              className="mt-10 md:mt-14 pt-8 border-t border-white/10"
            >
              <Link
                href="/blog"
                className="inline-flex items-center gap-2 text-white/60 hover:text-white text-[14px] md:text-[15px] transition-colors duration-300"
                style={{ fontFamily: "'Lato', sans-serif" }}
              >
