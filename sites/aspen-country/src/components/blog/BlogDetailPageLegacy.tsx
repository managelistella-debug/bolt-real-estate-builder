...
export default function BlogDetailPageLegacy({
  ...
  return (
    <div className="relative">
      {/* Locked-in-place background covering the full viewport. Positive
          z-index so the fixed layers paint above any solid background on
          the public layout, which would otherwise hide the image. */}
      <div
        aria-hidden
