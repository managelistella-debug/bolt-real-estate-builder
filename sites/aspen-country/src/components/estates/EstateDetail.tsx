...
import { Estate, formatPrice } from "@/lib/estates";
...
export default function EstateDetail({ estate }: EstateDetailProps) {
  ...
  const detailItems = [
    ...
    { label: "Bathrooms", value: estate.bathrooms },
    {
      ...
      value: estate.livingArea.toLocaleString(),
    },
    {
      label: "Lot Area",
      value: `${estate.lotArea.toLocaleString()} ${estate.lotAreaUnit}`,
    },
    ...
    ...(estate.representation
      ? [{ label: "Representation", value: estate.representation }]
      : []),
            ...
            <div className="overflow-hidden">
              <AnimatePresence mode="wait" custom={mobileDirection}>
                ...
                >
                  ...
                  >
                    <Image
                      src={estate.gallery[mobileIndex]}
                      alt={`${estate.address} - Photo ${mobileIndex + 1}`}
                      fill
                      className="object-cover"
                      sizes="100vw"
                    />
                  ...
                  {currentGalleryImages.map((image, index) => {
                    ...
                    return (
                      ...
                      >
                        <Image
                          src={image}
                          alt={`${estate.address} - Photo ${absoluteIndex + 1}`}
                          fill
