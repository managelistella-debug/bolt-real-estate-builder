...
const builderTemplate: Template = {
  ...
  defaultPages: [
      ...
      sections: [
        {
          ...
          widget: {
            ...
            cta: { text: 'View Acreages', url: '/acreages' },
            alignment: 'center',
          },
        },
        {
    ...
    },
    {
      ...
      isHomepage: false,
      sections: [
        { id: 'sp-estates-hero', type: 'hero', order: 0, widget: { type: 'hero', background: { type: 'image', url: `${BASE}/estate-hero.webp` }, headline: 'Acreages', subheadline: 'Exclusive rural acreages.', alignment: 'center' } },
        { id: 'sp-estates-list', type: 'listings', order: 1, widget: { type: 'listings', title: 'Acreages' } },
      ],
      seo: { metaTitle: 'Acreages | Country Real Estate', metaDescription: 'Browse exclusive acreages.' },
      status: 'published',
    },
    {
      name: 'Privacy Policy',
...
export const countryTemplate: StartingPointTemplate = {
  ...
  pages: [
    ...
    { name: 'Acreages', slug: '/acreages', description: 'Hero, acreage listings grid', sections: ['hero', 'listings'] },
