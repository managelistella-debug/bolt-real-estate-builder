...
export interface BlogPostTemplateConfig {
  ...
  heroLayoutMode: 'image_overlay' | 'title_with_thumbnail';
  heroTextAlign: 'left' | 'center';
  heroImageObjectPositionX: string;
  heroImageObjectPositionY: string;
  heroGradientEnabled: boolean;
  heroGradientStartColor: string;
  heroGradientStartOpacity: number;
  heroGradientEndColor: string;
  heroGradientEndOpacity: number;
  heroGradientAngle: number;
  showCategory: boolean;
  showDateAuthor: boolean;
  showTagsInHero: boolean;
